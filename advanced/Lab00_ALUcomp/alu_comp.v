...
always @(*) begin
    a_val = regs[...]; // To be completed: Get the value of src_a register
    b_val = regs[...]; // To be completed: Get the value of src_b register
end
...
always @(*) begin
    case (op)
        ...
        ... // To be completed: Implement SUB, MUL, and DIV2 operations
        default: begin
            result = 16'd0;
        end
    endcase
